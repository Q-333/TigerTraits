...
loadContactCard(userId: string): void {
  ...
  saveContactInfo() {
    //debug
    console.log('[saveContactInfo] CLICK');
    console.log('[saveContactInfo] valid?', this.contactForm.valid, this.contactForm.errors);
    console.log('[saveContactInfo] value:', this.contactForm.getRawValue());
